...
> Status: **v0.1.0**. The v0.1 surface is implemented and verified against
...
quietly. Python 3 and ripgrep are mandatory local test dependencies; either
absence fails the gate instead of silently reducing coverage.
